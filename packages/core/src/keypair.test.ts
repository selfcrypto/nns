...
/**
 * Externally supplied `publicKey → address` vectors: the four §3 addresses of
 * the pre-launch battery cast, generated outside this repo by separate Nimiq
 * tooling and confirmed by the author on 2026-08-13. The launch cast
 * (2026-09-22) was generated by this module, so pinning it here would check
 * the derivation against itself; these four stay because they are the ones
...
describe('the derivation is pinned outside this implementation', () => {
  ...
  it.each(PUBLIC_KEY_VECTORS)(
    "derives the battery cast's %s address from a public key generated elsewhere",
