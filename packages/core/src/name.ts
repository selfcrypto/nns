 ...
 * Name rules — spec §4.
 *
 * Deliberately independent of {@link ./config.ts | NnsConfig}: the reserved
 * list arrives as a plain set, so this module sits at the bottom of the
 * dependency order and can be tested with nothing else present.
 *
