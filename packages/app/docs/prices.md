...
The app reminds you from **{{dur:RENEW_WINDOW}}** before expiry, on every screen that shows the name, and by email or Telegram if you set that up ([Notifications](notifications)).
