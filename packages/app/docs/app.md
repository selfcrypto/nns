...
| Confirmed on chain. The registry will show it within a minute or two. | The chain has it; the resolver reads in batches and is up to a minute or two behind. Nothing to do |
